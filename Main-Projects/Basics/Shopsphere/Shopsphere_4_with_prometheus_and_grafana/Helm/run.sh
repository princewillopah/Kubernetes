...
# helm upgrade --install shopsphere ${current_dir} -n shopsphere
echo "------------------------------------------------------------------------" 
echo "Deploying Secrets: "
echo "------------------------------------------------------------------------"
helm upgrade --install shopsphere-secrets ${current_dir}/charts/shopsphere-secrets -n shopsphere -f ${current_dir}/environments/prod/secrets.yaml
echo "------------------------------------------------------------------------ "
echo " "
echo "------------------------------------------------------------------------" 
echo "Deploying Mongo: "
echo "------------------------------------------------------------------------"
helm upgrade --install shopsphere-mongo ${current_dir}/charts/shopsphere-mongo -n shopsphere -f ${current_dir}/environments/prod/mongo.yaml
echo "------------------------------------------------------------------------ "
echo " "
echo " "
echo "------------------------------------------------------------------------" 
...
echo "------------------------------------------------------------------------"
helm upgrade --install shopsphere-backend ${current_dir}/charts/shopsphere-backend -n shopsphere -f ${current_dir}/environments/prod/backend.yaml
echo " "
echo "------------------------------------------------------------------------ "
echo " "
echo "------------------------------------------------------------------------" 
...
echo "------------------------------------------------------------------------"
helm upgrade --install shopsphere-frontend ${current_dir}/charts/shopsphere-frontend -n shopsphere -f ${current_dir}/environments/prod/frontend.yaml
echo "------------------------------------------------------------------------ "
echo " "
...
echo " ================================================================= "
helm upgrade --install shopsphere-network-policies ${current_dir}/charts/shopsphere-network-policies  --namespace shopsphere
echo "------------------------------------------------------------------------" 
echo " "
echo " ================================================================= "
...
echo " ================================================================= "
  ...
  kubectl apply -f ${current_dir}/frontend-servicemonitor.yaml
  kubectl apply -f ${current_dir}/backend-servicemonitor.yaml
  kubectl apply -f ${current_dir}/mongo-servicemonitor.yaml
...
echo "------------------------------------------------------------------------"
echo " if any issue: kubectl get pods -n shopsphere"
...
echo "kubectl get pods -n shopsphere"
echo ""
...
echo ""
echo "Frontend → Mongo (MUST PASS): kubectl exec  <frontend-pod> -n shopsphere -- curl backend:5000/health"
echo ""
echo "Backend → Mongo (MUST PASS): kubectl exec  <backend-pod> -n shopsphere -- nc -zv mongo 27017"
echo ""
echo "Frontend → Mongo (MUST FAIL): kubectl exec -n shopsphere <frontend-pod> -- nc -zv mongo 27017"
