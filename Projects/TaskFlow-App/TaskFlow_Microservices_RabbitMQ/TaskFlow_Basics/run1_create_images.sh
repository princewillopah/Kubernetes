...
APP_NAME="taskflow-microservices"
image_tag="1.0.0"
...
# Result:
# princewillopah2/taskflow-microservices-task-service:1.0.0
# princewillopah2/taskflow-microservices-user-service:1.0.0
# princewillopah2/taskflow-microservices-notification-service:1.0.0
# princewillopah2/taskflow-microservices-analytics-service:1.0.0
# princewillopah2/taskflow-microservices-api-gateway:1.0.0
# princewillopah2/taskflow-microservices-frontend:1.0.0